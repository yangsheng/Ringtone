...
//                        Save_Path + "/" + File_Name);
    ...
    private void setRingtone(int type){
        try {
            ...
            if(type == 0){
                RingtoneManager.setActualDefaultRingtoneUri(this,RingtoneManager.TYPE_RINGTONE, m_path);
            }else if(type == 1){
                RingtoneManager.setActualDefaultRingtoneUri(this,RingtoneManager.TYPE_NOTIFICATION, m_path);
            }else {
                RingtoneManager.setActualDefaultRingtoneUri(this,RingtoneManager.TYPE_ALARM, m_path);
            }
            Ringtone rt = RingtoneManager.getRingtone(this,m_path);
            rt.play();
        } catch (Throwable t) {
